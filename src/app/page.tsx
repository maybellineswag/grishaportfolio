      ...
      <div className="flex flex-col gap-[80px] md:gap-[140px]">
        ...
        <FadeInSection>
          ...
          <div className="w-full md:w-[440px] pt-4 md:pt-[32px]">
            ...
            <Reveal className="mt-[20px] flex flex-col gap-[6px] items-center md:items-start" stagger={0.1} duration={1.2}>
        ...
        <FadeInSection>
          ...
          <div className="w-full md:w-[440px] pt-4 md:pt-[32px]">
            ...
            <Reveal className="mt-[20px] flex flex-col gap-[6px] items-start" stagger={0.1} duration={1.2}>
